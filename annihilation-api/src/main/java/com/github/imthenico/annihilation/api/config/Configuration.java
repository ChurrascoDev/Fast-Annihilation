...
import static com.github.imthenico.annihilation.api.util.Formatting.colorize;
...
public class Configuration extends YamlConfiguration {
    ...
    public List<String> getStringList(String path, String... def) {
        ...
        if (list.isEmpty()) {
            list = Arrays.asList(colorize(def));
        } else {
            colorize(list);
        }
